...
ActiveRecord::Schema[8.0].define(version: 2026_03_03_100001) do
  ...
  create_table "users", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.integer "srs_cards_count", default: 0, null: false
    t.integer "review_logs_count", default: 0, null: false
